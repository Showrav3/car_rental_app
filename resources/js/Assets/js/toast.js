window.successToast = function (msg) {
    Toastify({
        text: `<span>${msg}</span>
               <span style="cursor: pointer; color: #19cb00; margin-left: 10px; display: flex; justify-content: center; align-items: center;" onclick="this.parentNode.style.display='none'">
